...
public final class GrilleImpl implements Grille {
  ...
  /** Matrice représentant l'état de la grille. */
  private final ValeurDeCase[][] grille;

  /** Indicateurs pour savoir si une case contient une valeur initiale. */
  private final boolean[][] isInitial;

  /** Ensemble des valeurs autorisées pour l'ensemble du jeu. */
  private final Set<ValeurDeCase> valeursAutorisees;

  /** Tableau des valeurs valides numériques de la grille. */
  ...
  /**
   * Vérifie les règles Sudoku (lignes, colonnes, blocs) autour de (row, col).
   *
